      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl max-w-md w-full p-6 sm:p-8 shadow-2xl my-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white">
            {isLogin ? '👋 Welcome Back!' : '🚀 Join Focus Zone'}
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
          <p className="text-xs text-blue-800 dark:text-blue-300">
            <strong>💡 Demo Mode:</strong> This uses local storage. For production, integrate with Firebase, Supabase, or your backend API.
          </p>
        </div>
      </div>
    </div>
